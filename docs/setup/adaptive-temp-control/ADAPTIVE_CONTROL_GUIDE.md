...
```mermaid
flowchart TD
    subgraph METEN["1️⃣ Meten"]
        A[Sensor stuurt temperatuur<br/>bijv. 20.5°C]
    end
    
    subgraph VERGELIJKEN["2️⃣ Vergelijken"]
        B[Gewenst: 21.0°C<br/>Werkelijk: 20.5°C<br/>Afwijking: -0.5°C]
    end
    
    subgraph BEREKENEN["3️⃣ PI-algoritme"]
        C[P-term: 3.0 × -0.5 = -1.5°C<br/>I-term: correctie historisch<br/>Totaal: -1.5°C]
    end
    
    subgraph AANPASSEN["4️⃣ Aanpassen"]
        D[Setpoint: 45°C → 43°C<br/>Max 1x per 20 min<br/>Max ±3°C per keer]
    end
...
### v2.3.0 (2026-01-09)
- 📖 Documentatie herzien en vereenvoudigd
- 🎯 Mermaid diagrammen toegevoegd
- 📋 Tabellen voor betere leesbaarheid

### v1.4.0 (2024-12-18)
- ✨ Eerste release Adaptive Temperature Control
- ✅ PI-controller met persistence
- ✅ Flow cards en expert mode
- ✅ Anti-oscillatie throttling (20 min)
- ✅ Safety limits (±3°C, 15-28°C)
